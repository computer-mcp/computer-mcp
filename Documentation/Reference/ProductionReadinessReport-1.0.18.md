# Computer MCP 1.0.18 Production Readiness Report
...
| App/CLI package and version boundary | 1.0.18 (19), passed by the bound run |
...
| --- | --- | --- |
| Apple Silicon, macOS 14+ | DMG cold install, Finder launch, labeled menu-bar item, close/reopen lifecycle, TCC/state/CLI lifecycle, and exact catalog | Required before draft publication |
...
A physical Intel Mac is not a 1.0.18 release gate. Universal 2 slice checks and
