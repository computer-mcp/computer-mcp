# Computer MCP 1.0.19 Production Readiness Report
...
| App/CLI package and version boundary | 1.0.19 (20), passed by the bound run |
...
A physical Intel Mac is not a 1.0.19 release gate. Universal 2 slice checks and
