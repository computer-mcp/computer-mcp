# Computer MCP 1.0.21 Production Readiness Report
...
| App/CLI package and version boundary | 1.0.21 (22), passed by the bound run |
...
A physical Intel Mac is not a 1.0.21 release gate. Universal 2 slice checks and
