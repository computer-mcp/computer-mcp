# Computer MCP 1.0.22 Production Readiness Report
...
| App/CLI package and version boundary | 1.0.22 (23), passed by the bound run |
...
| Codex lifecycle fixture | Turn completion, thread read/fork, live review interruption, and fail-closed response handling are deterministic |
...
A physical Intel Mac is not a 1.0.22 release gate. Universal 2 slice checks and
...
installation matrix and all canonical Test Cases passed on this exact artifact.
The publisher must not rebuild or replace any checksummed asset between
