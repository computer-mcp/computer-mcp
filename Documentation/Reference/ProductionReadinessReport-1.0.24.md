# Computer MCP 1.0.24 Production Readiness Report
...
| App/CLI package and version boundary | 1.0.24 (25), passed by the bound run |
...
A physical Intel Mac is not a 1.0.24 release gate. Universal 2 slice checks and
...
Publishing the 1.0.24 GitHub draft and enabling the reviewed Pages deployment
...
replaced between acceptance and publication. The immutable `v1.0.23` tag and
its unpublished draft remain the audit record for the rejected candidate; they
must never be moved or substituted for 1.0.24.
