...
Publishing the 1.0.25 GitHub draft and enabling the reviewed Pages deployment
...
replaced between acceptance and publication. The immutable `v1.0.23` and
`v1.0.24` tags and their unpublished drafts remain the audit records for the
rejected candidates; they must never be moved or substituted for 1.0.25.
