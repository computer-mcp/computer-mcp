# Computer MCP 1.0.5 Production Readiness Report
...
| DMG | `Computer-MCP-1.0.5-universal.dmg` |
...
A physical Intel Mac is not a 1.0.5 release gate. The Universal 2 slice checks
