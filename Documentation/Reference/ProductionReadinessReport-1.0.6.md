# Computer MCP 1.0.6 Production Readiness Report
...
| DMG | `Computer-MCP-1.0.6-universal.dmg` |
...
A physical Intel Mac is not a 1.0.6 release gate. The Universal 2 slice checks
