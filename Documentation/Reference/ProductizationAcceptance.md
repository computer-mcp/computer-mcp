...
| W1–W11 | Independent sibling Git repository `computer-mcp.github.io`; static product site, responsive control-path design, metadata/social assets, no `CNAME`, Vite build, HTML/link checks, Axe, desktop/mobile Playwright, CI, and Pages workflow | Final local website check passed: production build and links passed; 11 browser tests passed and the desktop-only mobile-menu case skipped by design; coordinated publication remains |
| Q1–Q12 | Q1–Q9 passed locally, including strict format/lint, native root and Validation builds, 789 root tests, 67 Validation tests, 22 canonical Test Cases, real Codex acceptance, development Universal 2 App/DMG verification, documentation, release-boundary regressions, and both website gates | Q10–Q12 remain pending until logical commits, clean worktrees, cold-start audit, and coordinated publication readiness |
| CS1–CS10 | Must run after both repositories are self-contained | Pending |
