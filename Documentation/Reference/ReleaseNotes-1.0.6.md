# Computer MCP 1.0.6 Release Notes
...
- Root-level, checksummed App and DMG notarization receipts with fail-closed
...
1. Download `Computer-MCP-1.0.6-universal.dmg` and `SHA256SUMS` from the same
   GitHub Release.
