# Computer MCP 1.2.1 Release Notes
...
- Serialize gateway startup, shutdown and restart so workspace changes and
  background recovery cannot leave conflicting socket listeners.
...
Verify `SHA256SUMS` before installing `Computer-MCP-1.2.1-universal.dmg`.
